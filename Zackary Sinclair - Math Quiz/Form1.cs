...
namespace Zackary_Sinclair___Math_Quiz
{
    public partial class Form1 : Form
    {
        ...
        /// </summary>
        /// <remarks>Return true if the answer's correct, false otherwise.</remarks>
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (CheckTheAnswer())
            {
                ...
                timeLabel.BackColor = DefaultBackColor; // Reset color
            }
            else if (timeLeft > 0)
            {
                ...
                // Change the color to red when only 5 seconds remain.
                if (timeLeft <= 5)
                {
